...
class Search extends Component {
    ...
    constructor(props){
        ...
        this.state={
            name: '',
            author: '',
            cat:['Science','Economics','Fiction','Electronics','Management','Children','Personal Development']
        }
    ...
    return(
        ...
        <Col xs={6} md={3}>
          <Label check for="romance">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="romance" value="Science" name="cat" />
            Science 
          </Label>
        </Col>
        <Col xs={6} md={3}>
          <Label check for="fiction">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="fiction" value="Economics" name="cat" />
            Economics
          </Label>
          </Col>
          ...
          <Label check for="Arts">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="Arts" value="Fiction" name="cat" />
            Fiction
          </Label>
          </Col>
          <Col xs={6} md={3}>
          <Label check for="computer">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="computer" value="Management" name="cat" />
            Management
          </Label>
          </Col>
          </Row>
        ...
        <Col xs={6} md={3}>
          <Label check for="management">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="management" value="Electronics" name="cat" />
            Electronics 
          </Label>
        </Col>
        <Col xs={6} md={3}>
          <Label check for="Physics">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="Physics" value="Children" name="cat" />
            Children
          </Label>
          </Col>
          <Col xs={6} md={3}>
          <Label check for="Language">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="Language" value="Personal Development" name="cat" />

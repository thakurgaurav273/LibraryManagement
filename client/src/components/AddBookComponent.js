        ...
        this.props.postBook(values.name, values.author, values.description, values.isbn, values.cat, values.floor, values.shelf, values.copies);
                    ...
                    <Row className="form-group">
                        ...
                        <Row className="form-group">
                            ...
                            <Control.select defaultValue="Science" model=".cat" id="cat" className="form-control">
                              <option>Science</option> <option>Economics</option>
                              <option>Fiction</option> <option>Management</option>
                              <option>Electronics</option> <option>Children</option>
